<?php
	class Database {
		...
		//
		// COurces:
		public function InsertCourceData($title, $content, $poster, $createdate, $is_public)
		{
			$sql = "INSERT INTO cources(title, content, poster, is_public, createdate) VALUES ( '$title', '$content', '$poster', '$is_public', '$createdate')";
			return $this->execute($sql);
		}
		...
		public function UpdateCourceData($cources_id, $title, $content, $poster, $createdate, $is_public)
		{
